...
class ExperimentOrganizer():
    ...
    def setup_folders(self):
        ...
        dir_path = os.getcwd()
        os.makedirs(dir_path+self.root_path+'\\custom_code')
        os.makedirs(dir_path+self.root_path+'\\outputs\\states\\')
        os.makedirs(dir_path+self.root_path+'\\outputs\\logs\\')
        '''
    ...
    # def store_codebase(self, extensions):
        ...
        # os.system(f'cp --parents `find ./codebase/* -wholename "*{ext}"` {dir_path+self.root_path+'/custom_code'}/')
